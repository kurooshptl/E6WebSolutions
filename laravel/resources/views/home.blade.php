            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            <div class="icon"><i class="bx bxl-dribbble"></i></div>
                            <h4><a href="">10 Tips To Successful Mobile App Development</a></h4>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box">
                            <div class="icon"><i class="bx bx-file"></i></div>
                            <h4><a href="">Must-Have Things for a New Website</a></h4>
                            <P>Changes to develop a new website are becoming increasingly vital in a digitally-driven world so that customers and prospective clients can feel connected.
                                Give your website all it requires. </P>
                            <a href="#" class="buy-btn">READ MORE</a>
                         </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box">
                            <div class="icon"><i class="bx bx-tachometer"></i></div>
                            <h4><a href="">Behind the Scenes of an Intelligent Enterprise: The Transition of Enterprise Applications to the Cloud</a></h4>
