        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            <div class="icon"><img src="{{asset($item->image)}}" style="width: 300px;height: 200px;"></div>
                            <h4><a href="{{route('blog.show',$item->id)}}">{{$item->title}}</a></h4>
                            <p>{{substr($item->text,0,250)}}</p>
                            <a href="{{route('blog.show',$item->id)}}" class="buy-btn">READ MORE</a>
                        </div>
                    </div>
                        @endforeach
                </div>
